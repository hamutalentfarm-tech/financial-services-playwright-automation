...
- Name: transactions\transactions.spec.ts >> Transaction History @transactions >> TC-TXN-002: filtering by status "SUCCESS" returns only matching rows @regression
- Location: tests\transactions\transactions.spec.ts:21:7
