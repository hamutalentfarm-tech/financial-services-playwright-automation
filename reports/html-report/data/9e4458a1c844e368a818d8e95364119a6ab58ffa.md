...
- Name: api\portfolioRedemption.api.spec.ts >> API - Portfolio & Redemptions @api >> TC-API-020: GET /portfolio returns 200 with holdings scoped to the caller @smoke @api
- Location: tests\api\portfolioRedemption.api.spec.ts:11:7

# Error details

```
Error: Expected HTTP 200 but got 500 for http://8.231.116.131:8082/api/portfolio
