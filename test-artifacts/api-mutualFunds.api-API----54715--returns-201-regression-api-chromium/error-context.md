...
- Name: api\mutualFunds.api.spec.ts >> API - Mutual Funds @api >> TC-API-015: POST /investments with valid payload returns 201 @regression @api
- Location: tests\api\mutualFunds.api.spec.ts:60:7
