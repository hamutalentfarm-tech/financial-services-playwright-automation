...
- Name: api\mutualFunds.api.spec.ts >> API - Mutual Funds @api >> TC-API-011: each fund exposes required fields with allowed category/risk values @regression @api
- Location: tests\api\mutualFunds.api.spec.ts:20:7
...
Received array: ["Low Risk", "Moderate Risk", "High Risk", "Very High Risk"]
```
